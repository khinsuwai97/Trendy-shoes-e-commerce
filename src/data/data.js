...
import airjordan2 from '../images/Trending/airjordan2.jpeg';
import dunkLow from '../images/Trending/dunkLow.jpg';
import dunkLow2 from '../images/Trending/dunkLow2.jpeg';
import TravisScott from '../images/Trending/travis1-1.jpeg';
...
export const shoesData = [
  ...
  },
  {
    ...
    image1: yeezy2,
    description:
      'Released 07/06/2019 the Black Non-reflective edition of the Yeezy Boost 350 V2 is well renowned as being one of the most popular colour ways. Features Black prime knit and reflective laces.',
    quantity: 1,
    rating: {
      rate: 4.8,
      count: 120,
  ...
  },
  {
    ...
    image1: dunkLow2,
    description:
      'Cozy up with the Nike SB Dunk Low “Strange Love” this Valentine’s Day, a next-level collaboration imagined by skate company StrangeLove Skateboards that features premium velvet overlays and subtle nods to the lover’s holiday.Permeated with pastel, the makeup blends seductive shades of soft pink with hits of Bright Melon and Gym Red.',
    quantity: 1,
    rating: {
      rate: 4.8,
      count: 150,
  ...
  {
    id: 4,
    name: 'Air Jordan 1 Low OG TS "Travis Scott - Black Phantom"',
    price: 550,
    image: TravisScott,
    image1: TravisScott2,
    description:
      'The Travis Scott x Air Jordan 1 Low OG “Black Phantom” is a limited edition collaboration by the hip-hop star for a mostly monochromatic black colorway of Michael Jordan’s first signature shoe. The “Black Phantom” continues the Houston native’s collaborative run of Air Jordan 1 collaborations in a big, albeit somewhat unexpected way: by applying a versatile, mostly black design to the popular sneaker. The shoe’s black nubuck upper is paired with tonal suede overlays that feature white contrast',
